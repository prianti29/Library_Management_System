                ...
                <div class="form-items">
                    <form method="POST" action="{{ route('login') }}">
                       ...
                       <p>Login Form</p>
                        ...
                        <button type="submit" name="login" class="btn btn-info" style="padding: 10px 10px 10px 10px; margin-bottom: 50px; margin-top: 10px;">LOGIN </button> | <a href="{{ url('/register') }}">Not Register Yet</a>
                    </form>
                </div>
            </div>
                <div class="footer">
